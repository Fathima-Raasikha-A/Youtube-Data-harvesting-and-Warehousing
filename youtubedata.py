...
Api_Id="AIzaSyBUylvrFRVSRDbvEh2QMhgEauejYKYzq2Q"
...
#connect with mongodb and create lake
...
# table creation for channels,videos,comment
def channel_tables():
...
if question == "1. All the videos and the channel name":
    ...
    mydb.commit()
    t1 = cursor.fetchall()
    dfs1 = pd.DataFrame(t1,columns=["video title","channel name"])
    st.write(dfs1)
    ...
    mydb.commit()
    t3 = cursor.fetchall()
    dfs3 = pd.DataFrame(t3,columns=["views","videotitle","channel name"])
    st.write(dfs3)
    ...
    mydb.commit()
    t5 = cursor.fetchall()
    dfs5 = pd.DataFrame(t5,columns=["video title","Like Count","channel name"])
    st.write(dfs5)
    ...
    mydb.commit()
    t6 = cursor.fetchall()
    dfs6 = pd.DataFrame(t6,columns=["video title","like count"])
    st.write(dfs6)
    ...
    mydb.commit()
    t10 = cursor.fetchall()
    dfs10 = pd.DataFrame(t10,columns=["videos title","comments","channel name"])
    st.write(dfs10)
